...
public class MyEglHelper {
    ...
    public void initEgl(Surface surface, EGLContext eglContext) {
        ...
        //3.初始化默认显示设备
        int version[] = new int[2];//TODO ： 为什么这里的数组size是2呢
        if (!mEgl.eglInitialize(mEglDisplay, version)) {
            throw new RuntimeException("init EGL_DEFAULT_DISPLAY error");
        }
        //4.设置显示设备的属性
        int[] attrs = new int[]{EGL10.EGL_RED_SIZE, 8, EGL10.EGL_GREEN_SIZE, 8, EGL10.EGL_BLUE_SIZE, 8, EGL10.EGL_ALPHA_SIZE, 8, EGL10.EGL_DEPTH_SIZE, 8, EGL10.EGL_STENCIL_SIZE, 8, EGL10.EGL_RENDERABLE_TYPE, 4, EGL10.EGL_NONE};

        int[] num_config = new int[1];//TODO:这里的numconfig 是啥作用，为什么size是1
        ...
        //6.创建 EglContext
        int[] attr_list = {EGL14.EGL_CONTEXT_CLIENT_VERSION, 2, EGL10.EGL_NONE};
        if (eglContext != null) {
