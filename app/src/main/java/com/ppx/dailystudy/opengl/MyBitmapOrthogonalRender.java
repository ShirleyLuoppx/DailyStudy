 ...
 * @Desc： 正交投影  矩阵变换
 */
public class MyBitmapOrthogonalRender implements CustomGLSurfaceView.MyGLRender {
    ...
    public MyBitmapOrthogonalRender(Context context) {
    ...
    public void onSurfaceCreated() {
        //加载顶点着色器 shader
        String vertexSource = ShaderUtils.getRawResource(mContext, R.raw.screen_vert_matrix);
        //加载片元着色器 shader
    ...
    public void onSurfaceChanged(int width, int height) {
        ...
        BitmapFactory.decodeResource(mContext.getResources(), R.mipmap.nobb, options);
