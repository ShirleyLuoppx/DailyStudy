...
public class SpannableStringUtils {
    ...
    public SpannableStringUtils setColor(int color, int start, int end) {
        if (ssb == null) {
            ...
            ssb.setSpan(new ForegroundColorSpan(context.getResources().getColor(color)), start, end, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        }
        return this;
    }
    ...
    public SpannableStringUtils setBgColor(int bgcolor, int start, int end) {
        if (ssb == null) {
            ...
            ssb.setSpan(new BackgroundColorSpan(bgcolor), start, end, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        }
        return this;
    }
    ...
    public SpannableStringUtils setUrl(String url, int start, int end) {
        if (ssb == null) {
            ...
            ssb.setSpan(new URLSpan(url), start, end, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        }
        return this;
    }
    ...
    public SpannableStringUtils setTel(String tel, int start, int end) {
        if (ssb == null) {
            ...
            ssb.setSpan(new URLSpan("tel:" + tel), start, end, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        }
        return this;
    }
     ...
     * 设置自定义事件
     */
    public SpannableStringUtils setCustomClick(int foreColor, int bgColor, int start, int end, SpannableStringUtilsOnClick spannableStringUtilsOnClick) {
        if (ssb == null) {
            span.setSpan(new CustomURLSpan(span.toString().substring(start, end), bgColor, foreColor, spannableStringUtilsOnClick), start, end, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        } else {
            ssb.setSpan(new CustomURLSpan(ssb.toString().substring(start, end), bgColor, foreColor, spannableStringUtilsOnClick), start, end, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        }
        return this;
    }
    ...
    public SpannableStringUtils setDelLine(boolean isDel, int start, int end) {
        if (ssb == null) {
            ...
            ssb.setSpan(isDel ? new StrikethroughSpan() : new UnderlineSpan(), start, end, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        }
        return this;
    }
    ...
    public SpannableStringUtils setImage(Bitmap bitmap, int start, int end) {
        ...
        if (ssb == null) {
            ...
            ssb.setSpan(imgspan, start, end, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        }
        return this;
    }
    ...
    public SpannableStringUtils setTextSize(int textSize, int start, int end) {
        if (ssb == null) {
            span.setSpan(new AbsoluteSizeSpan(textSize), start, end, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        } else {
            ssb.setSpan(new AbsoluteSizeSpan(textSize), start, end, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        }
        return this;
    }
    ...
    public SpannableStringUtils setCanncelUnderLine(int start, int end) {
        if (ssb == null) {
            ...
            ssb.setSpan(new CanncelUnderLine(), start, end, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        }
        return this;
    }
     ...
     * 设置部分文字的点击
     */
    public SpannableStringUtils setOnClick(String str, final int foreColor, final int bgColor, final String clickId, final SpannableStringUtilsOnClick spannableStringUtilsOnClick) {
        if (ssb == null) {
    ...
    public SpannableStringUtils setOnClick(int start, int end, final int foreColor, final int bgColor, final boolean isLine, final String clickId, final SpannableStringUtilsOnClick spannableStringUtilsOnClick) {
        if (ssb == null) {
            ssb = new SpannableStringBuilder(span);
        }
        ssb.setSpan(new ClickableSpan() {
    ...
    public class CustomURLSpan extends URLSpan {
        ...
        public CustomURLSpan(String url, int foreColor, int bgColor, SpannableStringUtilsOnClick spannableStringUtilsOnClick) {
            super(url);
        ...
        public void onClick(View widget) {
            if (spannableStringUtilsOnClick != null) {
                spannableStringUtilsOnClick.onClick(null);
            }
        }
