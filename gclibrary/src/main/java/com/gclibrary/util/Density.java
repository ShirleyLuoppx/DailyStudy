...
public class Density {
    ...
    private static void setAppOrientation(@Nullable Activity activity) {
        ...
        try {
            boolean isPortrait = appDisplayMetrics.widthPixels < appDisplayMetrics.heightPixels;//判断是否为竖屏
            targetDensity = isPortrait ? (appDisplayMetrics.widthPixels / WIDTH) : (appDisplayMetrics.heightPixels / WIDTH);
