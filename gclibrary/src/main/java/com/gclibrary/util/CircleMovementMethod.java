...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    private final static int DEFAULT_CLICKABLEA_COLOR_ID = R.color.title_bg;
    /**整个textView的背景色*/
    ...
    public CircleMovementMethod(Context context){
        ...
        this.clickableSpanBgClor = context.getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
