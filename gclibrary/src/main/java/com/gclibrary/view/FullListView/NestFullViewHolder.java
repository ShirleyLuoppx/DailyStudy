package com.gclibrary.view.FullListView;
...
public class NestFullViewHolder {
     ...
     * 关于事件的
     */
    public NestFullViewHolder setOnClickListener(int viewId, View.OnClickListener listener) {
        View view = getView(viewId);
    ...
    public NestFullViewHolder setOnLongClickListener(int viewId, View.OnLongClickListener listener) {
        View view = getView(viewId);
