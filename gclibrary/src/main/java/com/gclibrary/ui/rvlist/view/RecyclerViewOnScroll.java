...
//        LogUtils.i("mJRecyclerView.getLoadEnable()---"+mJRecyclerView.getLoadEnable());
//        ToastUtils.showShort(recyclerView.getContext(),""+mJRecyclerView.getLoadEnable());
        ...
        if (!mJRecyclerView.getLoadEnable() && (lastCompletelyVisibleItem == totalItemCount - 1) && (dx > 0 || dy > 0)) {
//            ToastUtils.showShort(mJRecyclerView.getContext(), "亲，已经没有更多内容了");
        }
